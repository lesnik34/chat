            ...
            <div className='container'>
                <div className='profile__wrapper'>
                    <div className='profile__info'>
                        <div className='profile__avatar' style={{backgroundImage: `url('${props.url}')`}}/>
                    ...
                    <button
                        ...
                        onClick={() => props.setUsersVision(!props.usersVision)}
                    >
                        <svg className='profile__icon' x="0px" y="0px" viewBox="0 0 512 512">
